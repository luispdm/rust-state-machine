...
mod test {
	...
	fn basic_proof_of_existence() {
        ...
        assert!(poe.create_claim(test_caller, test_claim).is_err_and(|e| e == "this content has already been claimed"));
        
        assert!(poe.revoke_claim(test_caller, "not inserted previously").is_err_and(|e| e == "claim does not exist"));
        assert!(poe.revoke_claim("0x456", test_claim).is_err_and(|e| e == "claim does not belong to caller"));
